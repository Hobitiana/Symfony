...
class UploadPlanController extends AbstractController
{
    ...
    public function new(HttpFoundationRequest $request, SessionInterface $session, EtapeService $etapesService, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted()) {
            ...
            if ($action === 'next' &&  $form->isValid()) {
                ...
                $session->set('etape10', $dataPlanMasse);
